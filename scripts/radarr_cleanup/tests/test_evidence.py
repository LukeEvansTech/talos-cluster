...
from radarr_cleanup.evidence import (
    build_crosswalk,
...
from radarr_cleanup.model import HistoryStatus, Origin

from .fixtures import NOW, days_ago, import_event, make_availability, make_film, play_row
...
class ViewingTests(unittest.TestCase):
    ...
    def setUp(self):
        self.crosswalk = build_crosswalk(
            {
                5000: {"guids": ["tmdb://1000", "imdb://tt0000001"], "title": "Test Film", "year": 2026},
                6000: {"guids": ["tmdb://2000", "imdb://tt0000002"], "title": "Other", "year": 2001},
            }
        )
    ...
    def test_one_user_playing_twice_counts_once(self):
        ...
        rows = {5000: [play_row(5000, 11, 95, 1), play_row(5000, 11, 99, 2), play_row(5000, 11, 91, 3)]}
        result = resolve_viewing(make_film(), rows, self.crosswalk, days_ago(400), make_availability())
    ...
    def test_identity_falls_back_to_imdb_then_title(self):
        crosswalk = {7000: {"tmdb": None, "imdb": "tt0000001", "title": "Test Film", "year": 2026}}
    ...
    def test_plays_on_a_retired_plex_item_taint_the_zero(self):
        ...
        unattributed = [{"title": "Spirited Away", "year": 2001, "user_id": 11, "percent_complete": 99}]
        result = resolve_viewing(
            film, {}, {}, days_ago(400), make_availability(), unattributed_rows=unattributed
        )
    ...
    def test_alternate_title_under_a_resolved_key_still_matches_by_id(self):
        ...
        crosswalk = {9000: {"tmdb": 1000, "imdb": "tt0000001", "title": "Sen to Chihiro", "year": 2001}}
    ...
    def test_unavailable_history_is_its_own_state(self):
        result = resolve_viewing(
            make_film(), {}, self.crosswalk, days_ago(400), make_availability(), history_ok=False
        )
    ...
    def test_historical_rating_key_still_counts(self):
        ...
        crosswalk[4000] = {"tmdb": 1000, "imdb": "tt0000001", "title": "Test Film", "year": 2026}
